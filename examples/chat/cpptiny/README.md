...
A simple TCP chat demonstrating the bakelite cpptiny runtime.
...
add_custom_command(
    OUTPUT proto.h
    COMMAND ${BAKELITE_EXECUTABLE} gen -l cpptiny -i ../chat.bakelite -o proto.h
...
Uses the same protocol as the ctiny (C) version. You can run a C++ server with a C client or vice versa.
